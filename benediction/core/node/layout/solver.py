...
from benediction._utils import Bounds

BoundSequence = typing.Sequence[Bounds]
...
def _flatten_bounds(bounds: BoundSequence) -> list[tuple[int, bool]]:
...
def _solve_table(bounds: BoundSequence) -> SolutionTable:
...
def solve(bounds: BoundSequence, budget: int):
